...
import { taggedTemplateFormat } from './taggedTemplateFormatter';
...
export default class HtmlTemplateLanguageService implements TemplateLanguageService {
  ...
  public getFormattingEditsForRange(
    ...
    const edits = taggedTemplateFormat(document, range, {
...
function translateionCompletionItemKind(typescript: typeof ts, kind: vscode.CompletionItemKind): ts.ScriptElementKind {
  switch (kind) {
